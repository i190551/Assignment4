...
public class PaymentforMen {
    ...
    @FXML
    void pay3(ActionEvent event) throws IOException {
    ...
    @FXML
    void back_payment(ActionEvent event) throws IOException {
    ...
    @FXML
    void pay2(ActionEvent event) throws IOException {
