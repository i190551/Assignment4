...
public class PaymentforKids {
    ...
    @FXML
    void back_payment4(ActionEvent event) {
    ...
    @FXML
    void back_payment3(ActionEvent event) {
    ...
    @FXML
    void back_payment2(ActionEvent event) {
    ...
    @FXML
    void back_payment1(ActionEvent event) {
